...
@admin_bp.route('/admin/delete_outdated_drives', methods = ['POST'])
def delete_outdated_drives():
    drives = PlacementDrive.query.filter(PlacementDrive.deadline < datetime.utcnow()).all()
    for drive in drives:
