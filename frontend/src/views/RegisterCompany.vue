<template>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card p-4">
          <h3 class="mb-3 text-center">Company Registration</h3>
          ...
          <div class="mb-3">
            ...
            <textarea v-model="form.company_description" class="form-control"></textarea>
          </div>
          <div class="mb-3">
...
export default {
  data() {
    return {
      form: { name: '', email: '', password: '', company_description: '', industry: '', location: '', website: '' },
      error: '',
      message: ''
    }
  },
  methods: {
    async register() {
      try {
        const res = await api.post('/api/auth/register/company', this.form)
